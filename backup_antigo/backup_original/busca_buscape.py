...
class BuscadorBuscaPe:
    """Classe para buscar produtos no BuscaPé"""
    ...
    def buscar_produtos(self, termo_busca):
        ...
        # Busca apenas na primeira página (melhores resultados do BuscaPé)
        url = f"{self.base_url}/search?q={quote_plus(termo_busca)}"
        print(f"📄 Buscando primeira página (melhores resultados do BuscaPé)...")
        ...
        try:
            ...
            return {
                ...
                'total_encontrado': 0,
                'total_filtrado': 0,
                'erro': f'Erro ao acessar BuscaPé: {str(e)}'
            }
    ...
    def _extrair_produtos_pagina(self, soup):
        ...
        # Busca por itens de produto no BuscaPé
